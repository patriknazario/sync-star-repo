  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        head_cell: "text-muted-foreground rounded-md flex-1 font-semibold text-sm uppercase tracking-wide",
        row: "flex w-full mt-1",
        cell: "flex-1 h-14 text-center text-sm p-0 relative hover:bg-accent/50 rounded-md transition-colors",
        day: cn(buttonVariants({ variant: "ghost" }), "h-14 w-full p-0 font-normal aria-selected:opacity-100 hover:bg-transparent"),
